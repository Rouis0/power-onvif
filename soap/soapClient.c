...
SOAP_SOURCE_STAMP("@(#) soapClient.c ver 2.8.8 2013-11-29 02:49:07 GMT")
...
{	struct __ns10__Renew soap_tmp___ns10__Renew;
	...
	soap->encodingStyle = NULL;
	soap_tmp___ns10__Renew.wsnt__Renew = wsnt__Renew;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns10__Renew(soap, &soap_tmp___ns10__Renew);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns10__Renew(soap, &soap_tmp___ns10__Renew, "-ns10:Renew", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns10__Unsubscribe soap_tmp___ns10__Unsubscribe;
	...
	soap->encodingStyle = NULL;
	soap_tmp___ns10__Unsubscribe.wsnt__Unsubscribe = wsnt__Unsubscribe;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns10__Unsubscribe(soap, &soap_tmp___ns10__Unsubscribe);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns10__Unsubscribe(soap, &soap_tmp___ns10__Unsubscribe, "-ns10:Unsubscribe", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns10__PauseSubscription soap_tmp___ns10__PauseSubscription;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/PauseSubscriptionRequest";
	soap->encodingStyle = NULL;
	soap_tmp___ns10__PauseSubscription.wsnt__PauseSubscription = wsnt__PauseSubscription;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns10__PauseSubscription(soap, &soap_tmp___ns10__PauseSubscription);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns10__PauseSubscription(soap, &soap_tmp___ns10__PauseSubscription, "-ns10:PauseSubscription", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns10__ResumeSubscription soap_tmp___ns10__ResumeSubscription;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/ResumeSubscriptionRequest";
	soap->encodingStyle = NULL;
	soap_tmp___ns10__ResumeSubscription.wsnt__ResumeSubscription = wsnt__ResumeSubscription;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns10__ResumeSubscription(soap, &soap_tmp___ns10__ResumeSubscription);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns10__ResumeSubscription(soap, &soap_tmp___ns10__ResumeSubscription, "-ns10:ResumeSubscription", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns11__Hello soap_tmp___ns11__Hello;
	...
	soap->encodingStyle = NULL;
	soap_tmp___ns11__Hello.tdn__Hello = tdn__Hello;
	soap_begin(soap);
	soap_serializeheader(soap);
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns11__Hello(soap, &soap_tmp___ns11__Hello, "-ns11:Hello", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns11__Bye soap_tmp___ns11__Bye;
	...
	soap->encodingStyle = NULL;
	soap_tmp___ns11__Bye.tdn__Bye = tdn__Bye;
	soap_begin(soap);
	soap_serializeheader(soap);
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns11__Bye(soap, &soap_tmp___ns11__Bye, "-ns11:Bye", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns12__Probe soap_tmp___ns12__Probe;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver10/network/wsdl/Probe";
	soap->encodingStyle = NULL;
	soap_tmp___ns12__Probe.tdn__Probe = tdn__Probe;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns12__Probe(soap, &soap_tmp___ns12__Probe);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns12__Probe(soap, &soap_tmp___ns12__Probe, "-ns12:Probe", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns13__GetSupportedRules soap_tmp___ns13__GetSupportedRules;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/GetSupportedRules";
	soap->encodingStyle = NULL;
	soap_tmp___ns13__GetSupportedRules.tan__GetSupportedRules = tan__GetSupportedRules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns13__GetSupportedRules(soap, &soap_tmp___ns13__GetSupportedRules);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns13__GetSupportedRules(soap, &soap_tmp___ns13__GetSupportedRules, "-ns13:GetSupportedRules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns13__CreateRules soap_tmp___ns13__CreateRules;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/CreateRules";
	soap->encodingStyle = NULL;
	soap_tmp___ns13__CreateRules.tan__CreateRules = tan__CreateRules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns13__CreateRules(soap, &soap_tmp___ns13__CreateRules);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns13__CreateRules(soap, &soap_tmp___ns13__CreateRules, "-ns13:CreateRules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns13__DeleteRules soap_tmp___ns13__DeleteRules;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/DeleteRules";
	soap->encodingStyle = NULL;
	soap_tmp___ns13__DeleteRules.tan__DeleteRules = tan__DeleteRules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns13__DeleteRules(soap, &soap_tmp___ns13__DeleteRules);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns13__DeleteRules(soap, &soap_tmp___ns13__DeleteRules, "-ns13:DeleteRules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns13__GetRules soap_tmp___ns13__GetRules;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/GetRules";
	soap->encodingStyle = NULL;
	soap_tmp___ns13__GetRules.tan__GetRules = tan__GetRules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns13__GetRules(soap, &soap_tmp___ns13__GetRules);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns13__GetRules(soap, &soap_tmp___ns13__GetRules, "-ns13:GetRules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns13__ModifyRules soap_tmp___ns13__ModifyRules;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/ModifyRules";
	soap->encodingStyle = NULL;
	soap_tmp___ns13__ModifyRules.tan__ModifyRules = tan__ModifyRules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns13__ModifyRules(soap, &soap_tmp___ns13__ModifyRules);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns13__ModifyRules(soap, &soap_tmp___ns13__ModifyRules, "-ns13:ModifyRules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns14__GetServiceCapabilities soap_tmp___ns14__GetServiceCapabilities;
	...
	soap->encodingStyle = NULL;
	soap_tmp___ns14__GetServiceCapabilities.tan__GetServiceCapabilities = tan__GetServiceCapabilities;
	soap_begin(soap);
	soap_serializeheader(soap);
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns14__GetServiceCapabilities(soap, &soap_tmp___ns14__GetServiceCapabilities, "-ns14:GetServiceCapabilities", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns14__GetSupportedAnalyticsModules soap_tmp___ns14__GetSupportedAnalyticsModules;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/GetSupportedAnalyticsModules";
	soap->encodingStyle = NULL;
	soap_tmp___ns14__GetSupportedAnalyticsModules.tan__GetSupportedAnalyticsModules = tan__GetSupportedAnalyticsModules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns14__GetSupportedAnalyticsModules(soap, &soap_tmp___ns14__GetSupportedAnalyticsModules);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns14__GetSupportedAnalyticsModules(soap, &soap_tmp___ns14__GetSupportedAnalyticsModules, "-ns14:GetSupportedAnalyticsModules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns14__CreateAnalyticsModules soap_tmp___ns14__CreateAnalyticsModules;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/CreateAnalyticsModules";
	soap->encodingStyle = NULL;
	soap_tmp___ns14__CreateAnalyticsModules.tan__CreateAnalyticsModules = tan__CreateAnalyticsModules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns14__CreateAnalyticsModules(soap, &soap_tmp___ns14__CreateAnalyticsModules);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns14__CreateAnalyticsModules(soap, &soap_tmp___ns14__CreateAnalyticsModules, "-ns14:CreateAnalyticsModules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns14__DeleteAnalyticsModules soap_tmp___ns14__DeleteAnalyticsModules;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/DeleteAnalyticsModules";
	soap->encodingStyle = NULL;
	soap_tmp___ns14__DeleteAnalyticsModules.tan__DeleteAnalyticsModules = tan__DeleteAnalyticsModules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns14__DeleteAnalyticsModules(soap, &soap_tmp___ns14__DeleteAnalyticsModules);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns14__DeleteAnalyticsModules(soap, &soap_tmp___ns14__DeleteAnalyticsModules, "-ns14:DeleteAnalyticsModules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns14__GetAnalyticsModules soap_tmp___ns14__GetAnalyticsModules;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/GetAnalyticsModules";
	soap->encodingStyle = NULL;
	soap_tmp___ns14__GetAnalyticsModules.tan__GetAnalyticsModules = tan__GetAnalyticsModules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns14__GetAnalyticsModules(soap, &soap_tmp___ns14__GetAnalyticsModules);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns14__GetAnalyticsModules(soap, &soap_tmp___ns14__GetAnalyticsModules, "-ns14:GetAnalyticsModules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns14__ModifyAnalyticsModules soap_tmp___ns14__ModifyAnalyticsModules;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/ModifyAnalyticsModules";
	soap->encodingStyle = NULL;
	soap_tmp___ns14__ModifyAnalyticsModules.tan__ModifyAnalyticsModules = tan__ModifyAnalyticsModules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns14__ModifyAnalyticsModules(soap, &soap_tmp___ns14__ModifyAnalyticsModules);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns14__ModifyAnalyticsModules(soap, &soap_tmp___ns14__ModifyAnalyticsModules, "-ns14:ModifyAnalyticsModules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns3__PullMessages soap_tmp___ns3__PullMessages;
	...
	soap->encodingStyle = NULL;
	soap_tmp___ns3__PullMessages.tev__PullMessages = tev__PullMessages;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns3__PullMessages(soap, &soap_tmp___ns3__PullMessages);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns3__PullMessages(soap, &soap_tmp___ns3__PullMessages, "-ns3:PullMessages", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns3__Seek soap_tmp___ns3__Seek;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver10/events/wsdl/PullPointSubscription/SeekRequest";
	soap->encodingStyle = NULL;
	soap_tmp___ns3__Seek.tev__Seek = tev__Seek;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns3__Seek(soap, &soap_tmp___ns3__Seek);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns3__Seek(soap, &soap_tmp___ns3__Seek, "-ns3:Seek", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns3__SetSynchronizationPoint soap_tmp___ns3__SetSynchronizationPoint;
	...
	soap->encodingStyle = NULL;
	soap_tmp___ns3__SetSynchronizationPoint.tev__SetSynchronizationPoint = tev__SetSynchronizationPoint;
	soap_begin(soap);
	soap_serializeheader(soap);
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns3__SetSynchronizationPoint(soap, &soap_tmp___ns3__SetSynchronizationPoint, "-ns3:SetSynchronizationPoint", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns4__GetServiceCapabilities soap_tmp___ns4__GetServiceCapabilities;
	...
	soap->encodingStyle = NULL;
	soap_tmp___ns4__GetServiceCapabilities.tev__GetServiceCapabilities = tev__GetServiceCapabilities;
	soap_begin(soap);
	soap_serializeheader(soap);
...
{	struct __ns4__CreatePullPointSubscription soap_tmp___ns4__CreatePullPointSubscription;
	...
	soap->encodingStyle = NULL;
	soap_tmp___ns4__CreatePullPointSubscription.tev__CreatePullPointSubscription = tev__CreatePullPointSubscription;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns4__CreatePullPointSubscription(soap, &soap_tmp___ns4__CreatePullPointSubscription);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns4__CreatePullPointSubscription(soap, &soap_tmp___ns4__CreatePullPointSubscription, "-ns4:CreatePullPointSubscription", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns4__GetEventProperties soap_tmp___ns4__GetEventProperties;
	...
	soap->encodingStyle = NULL;
	soap_tmp___ns4__GetEventProperties.tev__GetEventProperties = tev__GetEventProperties;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns4__GetEventProperties(soap, &soap_tmp___ns4__GetEventProperties);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns4__GetEventProperties(soap, &soap_tmp___ns4__GetEventProperties, "-ns4:GetEventProperties", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns5__Renew soap_tmp___ns5__Renew;
	...
	soap->encodingStyle = NULL;
	soap_tmp___ns5__Renew.wsnt__Renew = wsnt__Renew;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns5__Renew(soap, &soap_tmp___ns5__Renew);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns5__Renew(soap, &soap_tmp___ns5__Renew, "-ns5:Renew", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns5__Unsubscribe soap_tmp___ns5__Unsubscribe;
	...
	soap->encodingStyle = NULL;
	soap_tmp___ns5__Unsubscribe.wsnt__Unsubscribe = wsnt__Unsubscribe;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns5__Unsubscribe(soap, &soap_tmp___ns5__Unsubscribe);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns5__Unsubscribe(soap, &soap_tmp___ns5__Unsubscribe, "-ns5:Unsubscribe", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns6__Subscribe soap_tmp___ns6__Subscribe;
	...
	soap->encodingStyle = NULL;
	soap_tmp___ns6__Subscribe.wsnt__Subscribe = wsnt__Subscribe;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns6__Subscribe(soap, &soap_tmp___ns6__Subscribe);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns6__Subscribe(soap, &soap_tmp___ns6__Subscribe, "-ns6:Subscribe", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns6__GetCurrentMessage soap_tmp___ns6__GetCurrentMessage;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/NotificationProducer/GetCurrentMessageRequest";
	soap->encodingStyle = NULL;
	soap_tmp___ns6__GetCurrentMessage.wsnt__GetCurrentMessage = wsnt__GetCurrentMessage;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns6__GetCurrentMessage(soap, &soap_tmp___ns6__GetCurrentMessage);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns6__GetCurrentMessage(soap, &soap_tmp___ns6__GetCurrentMessage, "-ns6:GetCurrentMessage", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns8__GetMessages soap_tmp___ns8__GetMessages;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/PullPoint/GetMessagesRequest";
	soap->encodingStyle = NULL;
	soap_tmp___ns8__GetMessages.wsnt__GetMessages = wsnt__GetMessages;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns8__GetMessages(soap, &soap_tmp___ns8__GetMessages);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns8__GetMessages(soap, &soap_tmp___ns8__GetMessages, "-ns8:GetMessages", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns8__DestroyPullPoint soap_tmp___ns8__DestroyPullPoint;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/PullPoint/DestroyPullPointRequest";
	soap->encodingStyle = NULL;
	soap_tmp___ns8__DestroyPullPoint.wsnt__DestroyPullPoint = wsnt__DestroyPullPoint;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns8__DestroyPullPoint(soap, &soap_tmp___ns8__DestroyPullPoint);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns8__DestroyPullPoint(soap, &soap_tmp___ns8__DestroyPullPoint, "-ns8:DestroyPullPoint", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns8__Notify soap_tmp___ns8__Notify;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/PullPoint/Notify";
	soap->encodingStyle = NULL;
	soap_tmp___ns8__Notify.wsnt__Notify = wsnt__Notify;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns8__Notify(soap, &soap_tmp___ns8__Notify);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns8__Notify(soap, &soap_tmp___ns8__Notify, "-ns8:Notify", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{
	soap_default___ns8__Notify(soap, _param_8);
	soap_begin(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get___ns8__Notify(soap, _param_8, "-ns8:Notify", NULL);
	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
		soap->error = SOAP_NO_METHOD;
	if (soap->error
	 || soap_body_end_in(soap)
...
{	struct __ns9__CreatePullPoint soap_tmp___ns9__CreatePullPoint;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/CreatePullPoint/CreatePullPointRequest";
	soap->encodingStyle = NULL;
	soap_tmp___ns9__CreatePullPoint.wsnt__CreatePullPoint = wsnt__CreatePullPoint;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns9__CreatePullPoint(soap, &soap_tmp___ns9__CreatePullPoint);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns9__CreatePullPoint(soap, &soap_tmp___ns9__CreatePullPoint, "-ns9:CreatePullPoint", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
